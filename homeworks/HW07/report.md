...
Результаты для каждого из seed оказались идентичны.   
У всех прогонов ARI и NMI равнялись 1.0   
Значения метрик так же оставвались идентичными   
