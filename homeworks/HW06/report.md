...
Данный эксперимент показал, что в задачах бинарной классификации с нелинейными связями и шумом очень сильно выигрывают ансамбли деревьев.   
Лучше всех справился HistGradientBoosting, т.к. он обучается на ошибках и старается их минимизировать.   
Я понял важность правильного разделения данных на тренировочные и тестовые, что нужно быть внимательным к утечкам и обучать модели **ТОЛЬКО** на тренировочных данных, а на тестовых замерять их точность.
